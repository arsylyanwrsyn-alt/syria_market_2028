  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: const Text('إعلاناتي المنشورة 📢', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
      ),
      body: _isLoading
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('لم تقم بنشر أي إعلانات بعد', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                    ...
                    itemBuilder: (ctx, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text('${ad['price_syp'] ?? 0} ل.س - ${ad['province'] ?? ''}', style: const TextStyle(fontSize: 12)),
                          trailing: Chip(
                            label: Text(
                              isSold ? 'تم البيع' : 'نشط',
                              style: TextStyle(color: isSold ? Colors.white : Colors.green.shade900, fontSize: 10),
                            ),
